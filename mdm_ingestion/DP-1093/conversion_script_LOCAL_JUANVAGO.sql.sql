...
SELECT SRC_FK_FACILITY_ID, SRC_YEAR, SRC_METRIC_LABEL, SRC_METRIC, 'historical/historical/na_postacute', RECORD_ID
...
SELECT SRC_FK_PROVIDER_ID, SRC_YEAR, SRC_METRIC_LABEL, SRC_METRIC, 'historical/historical/na_provider', RECORD_ID
...
SELECT SRC_PAC_NUM, SRC_YEAR, SRC_SPECIALTY, SRC_METRIC_ORDER, SRC_METRIC_LABEL, SRC_METRIC, SRC_METRIC_TOTAL, 'historical/historical/profile_list_rndrg_pg', RECORD_ID
...
SELECT SRC_FK_PROVIDER_ID, SRC_PAC_NUM, SRC_YEAR, SRC_METRIC_ORDER, SRC_METRIC_LABEL, SRC_METRIC, 'historical/historical/na_rndrg', RECORD_ID
