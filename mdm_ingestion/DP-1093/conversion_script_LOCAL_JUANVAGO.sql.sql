...
SELECT SRC_NUMERATOR, SRC_DENOMINATOR, SRC_YEAR, SRC_PAC_NUM, SRC_EPISODE_TYPE, 'historical/historical/vrdc_cji_outcomes_scorecard', NULL, SRC_NPI, SRC_MEASURE_ID, SRC_MEASURE_DESC, SRC_SPECIALTY, SRC_CBSA, SRC_PROBABILITY, SRC_NATIONAL_PROB_STD, SRC_PROB_PERCENTILE
...
SELECT SRC_SPECIALTY, SRC_CBSA, SRC_PROBABILITY, SRC_NATIONAL_PROB_STD, SRC_PROB_PERCENTILE, SRC_NUMERATOR, SRC_DENOMINATOR, SRC_YEAR, SRC_EPISODE_TYPE, 'historical/historical/CJI_PAC_OUTCOMES_SCORECARD', NULL, SRC_PAC_NUM, SRC_MEASURE_ID, SRC_MEASURE_DESC
...
SELECT SRC_FK_PROVIDER_ID, SRC_MEDICAL_CD, SRC_MEDICAL_CD_DSCR, SRC_YEAR, SRC_BENE_CNT, SRC_CLAIM_CNT, SRC_TOTAL_ALLOWED, 'historical/historical/AXB_ICD_DX_X_NPI', NULL
...
SELECT SRC_CLAIM_TYPE, SRC_FK_PROVIDER_ID, SRC_MEDICAL_CD, SRC_YEAR, SRC_BENE_CNT, SRC_CLAIM_CNT, SRC_TOTAL_ALLOWED, 'historical/historical/AXB_HCPCS_X_NPI', NULL
FROM PROD_CJVRDC.ODS.VRDC_CLAIM_ACTIVITY_PROC
WHERE EFFECTIVE_FLAG AND RECORD_STATUS_CD = 'a';

INSERT INTO LOCAL_JUANVAGO.STAGE_VRDC.EGM_ACO (FK_ACO_ID, EPISODE_TYPE_CD, EPISODE_DESCRIPTION, RUN_YEAR, ATTRIBUTION_TYPE, CONNECTED_EPISODES, CONNECTED_SEQUELA, NUM_EPISODES, AVG_HCC_SCORE, AVG_EPISODE_COST, AVG_PARTB_COST, AVG_INPATIENT_COST, AVG_OUTPATIENT_COST, AVG_SNF_COST, AVG_HHA_COST, AVG_HOSPICE_COST, ACO_NAME, LOAD_FILE_NM, LOAD_FILE_ROW_NUM)
SELECT SRC_FK_ACO_ID, SRC_EPISODE_TYPE_CD, SRC_EPISODE_DESCRIPTION, SRC_RUN_YEAR, SRC_ATTRIBUTION_TYPE, SRC_CONNECTED_EPISODES, SRC_CONNECTED_SEQUELA, SRC_NUM_EPISODES, SRC_AVG_HCC_SCORE, SRC_AVG_EPISODE_COST, SRC_AVG_PARTB_COST, SRC_AVG_INPATIENT_COST, SRC_AVG_OUTPATIENT_COST, SRC_AVG_SNF_COST, SRC_AVG_HHA_COST, SRC_AVG_HOSPICE_COST, SRC_ACO_NAME, 'historical/historical/EGM_ACO', NULL
FROM PROD_CJVRDC.ODS.VRDC_EGM_ACO
WHERE EFFECTIVE_FLAG AND RECORD_STATUS_CD = 'a';

INSERT INTO LOCAL_JUANVAGO.STAGE_VRDC.EGM_GEO (AVG_INPATIENT_COST, AVG_OUTPATIENT_COST, AVG_SNF_COST, AVG_HHA_COST, AVG_HOSPICE_COST, LOAD_FILE_NM, LOAD_FILE_ROW_NUM, FK_GEOGRAPHY_ID, EPISODE_TYPE_CD, EPISODE_DESCRIPTION, RUN_YEAR, ATTRIBUTION_TYPE, CONNECTED_EPISODES, CONNECTED_SEQUELA, NUM_EPISODES, GEOGRAPHY_TYPE, AVG_HCC_SCORE, AVG_EPISODE_COST, AVG_PARTB_COST)
SELECT SRC_AVG_INPATIENT_COST, SRC_AVG_OUTPATIENT_COST, SRC_AVG_SNF_COST, SRC_AVG_HHA_COST, SRC_AVG_HOSPICE_COST, 'historical/historical/egm_geo', NULL, SRC_FK_GEOGRAPHY_ID, SRC_EPISODE_TYPE_CD, SRC_EPISODE_DESCRIPTION, SRC_RUN_YEAR, SRC_ATTRIBUTION_TYPE, SRC_CONNECTED_EPISODES, SRC_CONNECTED_SEQUELA, SRC_NUM_EPISODES, SRC_GEOGRAPHY_TYPE, SRC_AVG_HCC_SCORE, SRC_AVG_EPISODE_COST, SRC_AVG_PARTB_COST
FROM PROD_CJVRDC.ODS.VRDC_EGM_GEO
WHERE EFFECTIVE_FLAG AND RECORD_STATUS_CD = 'a';

INSERT INTO LOCAL_JUANVAGO.STAGE_VRDC.EGM_NPI (FK_PROVIDER_ID, PAC_NUM, EPISODE_TYPE_CD, EPISODE_DESCRIPTION, RUN_YEAR, ATTRIBUTION_TYPE, CONNECTED_EPISODES, CONNECTED_SEQUELA, TOP_EPISODE_HCPCS, NUM_EPISODES, AVG_HCC_SCORE, AVG_NPI_SPEND, AVG_EPISODE_COST, AVG_NPI_PARTB_COST, AVG_NPI_INPATIENT_COST, AVG_NPI_OUTPATIENT_COST, AVG_NPI_SNF_COST, AVG_NPI_HHA_COST, AVG_NPI_HOSPICE_COST, AVG_PARTB_COST, AVG_INPATIENT_COST, AVG_OUTPATIENT_COST, AVG_SNF_COST, AVG_HHA_COST, AVG_HOSPICE_COST, PCT_SEQUELA, PCT_PB_COST, PCT_IP_COST, PCT_OP_COST, PCT_SNF_COST, PCT_HHA_COST, PCT_HOSPICE_COST, LOAD_FILE_NM, LOAD_FILE_ROW_NUM)
SELECT SRC_FK_PROVIDER_ID, SRC_PAC_NUM, SRC_EPISODE_TYPE_CD, SRC_EPISODE_DESCRIPTION, SRC_RUN_YEAR, SRC_ATTRIBUTION_TYPE, SRC_CONNECTED_EPISODES, SRC_CONNECTED_SEQUELA, SRC_TOP_EPISODE_HCPCS, SRC_NUM_EPISODES, SRC_AVG_HCC_SCORE, SRC_AVG_NPI_SPEND, SRC_AVG_EPISODE_COST, SRC_AVG_NPI_PARTB_COST, SRC_AVG_NPI_INPATIENT_COST, SRC_AVG_NPI_OUTPATIENT_COST, SRC_AVG_NPI_SNF_COST, SRC_AVG_NPI_HHA_COST, SRC_AVG_NPI_HOSPICE_COST, SRC_AVG_PARTB_COST, SRC_AVG_INPATIENT_COST, SRC_AVG_OUTPATIENT_COST, SRC_AVG_SNF_COST, SRC_AVG_HHA_COST, SRC_AVG_HOSPICE_COST, SRC_PCT_SEQUELA, SRC_PCT_PB_COST, SRC_PCT_IP_COST, SRC_PCT_OP_COST, SRC_PCT_SNF_COST, SRC_PCT_HHA_COST, SRC_PCT_HOSPICE_COST, 'historical/historical/vrdc_egm_npi', NULL
...
SELECT SRC_BENCHMARK_TYPE, SRC_BENCHMARK, SRC_AGG_TYPE, SRC_COHORT_TYPE, SRC_ENROLLMENT_TYPE, SRC_YEAR, SRC_METRIC_LABEL, SRC_MEAN, SRC_STD_DEV, SRC_PCTL_20, SRC_PCTL_40, SRC_PCTL_60, SRC_PCTL_80, SRC_COUNT, SRC_TOTAL, 'historical/historical/BENCHMARKS_EXPORT', NULL
...
SELECT SRC_FK_PROVIDER_ID, SRC_FK_FACILITY_ID, SRC_PAC_NUM, SRC_EPISODE_TYPE_CD, SRC_EPISODE_SUBSET, SRC_MEASURE_ID, SRC_YEAR, SRC_NUM_EPISODES, SRC_AVG_HCC_SCORE, SRC_TOTAL_EPISODE_ALLOWED, SRC_STD_DEV_EPISODE_ALLOWED, SRC_PARTB_ALLOWED, SRC_INPATIENT_ALLOWED, SRC_OUTPATIENT_ALLOWED, SRC_SNF_ALLOWED, SRC_HHA_ALLOWED, SRC_HOSPICE_ALLOWED, SRC_PARTBDME_ALLOWED, SRC_MORTALITY_RATE, SRC_READMISSION_RATE, SRC_READMISSION_ALLOWED, 'historical/historical/NA_BPCI_TRIGGER_PROVIDER', NULL
...
SELECT SRC_ZIP_CD, SRC_CBSA_DESC, SRC_COUNTY_CD, SRC_COUNTY_DESC, SRC_STATE, 'historical/historical/NA_GEOGRAPHY', NULL
...
SELECT SRC_BILL_NPI, SRC_YEAR, SRC_SPEND, SRC_HASHED_TIN, 'historical/historical/NA_HASHED_TIN_X_BILL_NPI', NULL
FROM PROD_CJVRDC.ODS.VRDC_NA_HASHED_TIN_X_BILL_NPI
WHERE EFFECTIVE_FLAG AND RECORD_STATUS_CD = 'a';

INSERT INTO LOCAL_JUANVAGO.STAGE_VRDC.NPI_X_PROVIDER_ZIP (MULTI_ACO, CJ_INDEX_COST, CJ_INDEX_OUTCOMES, LOAD_FILE_NM, LOAD_FILE_ROW_NUM, NPI, YEAR, PROV_ZIP, ACO_ID)
SELECT SRC_MULTI_ACO, SRC_CJ_INDEX_COST, SRC_CJ_INDEX_OUTCOMES, 'historical/historical/NA_REF_NPI_X_PROVIDER_ZIP', NULL, SRC_NPI, SRC_YEAR, SRC_PROV_ZIP, SRC_ACO_ID
...
SELECT SRC_NPI, SRC_PRIMARY_SPECIALTY, SRC_PCT_PRIMARY_SPECIALTY, SRC_SECONDARY_SPECIALTY, 'historical/historical/NPI_X_SPECIALTY_EXPORT', NULL
...
SELECT SRC_FK_PROVIDER_ID, SRC_YEAR, SRC_TAXONOMY, SRC_CBSA, SRC_EPISODE, SRC_EPISODE_TYPE, SRC_PPI_COST_SCORE, SRC_COST_TEST_STATISTIC, SRC_VERSION, 'historical/historical/PPI_COST_SCORE', NULL
...
SELECT SRC_AVG_EXPECTED, SRC_AVG_OE, SRC_TEST_STATISTIC, SRC_AVG_HCC, SRC_AVG_CBSA_EPISODES, SRC_YEAR, SRC_TOT_PARTB_ALLOWED, SRC_TOT_INPATIENT_ALLOWED, SRC_TOT_OUTPATIENT_ALLOWED, SRC_TOT_SNF_ALLOWED, SRC_TOT_HHA_ALLOWED, SRC_TOT_HOSPICE_ALLOWED, SRC_TOT_PARTBDME_ALLOWED, SRC_VERSION, 'historical/historical/PPI_COST_SCORECARD', NULL, SRC_FK_PROVIDER_ID, SRC_EPISODE, SRC_EPISODE_TYPE, SRC_TAXONOMY, SRC_CBSA, SRC_NUM_EPISODES, SRC_AVG_OBSERVED
...
SELECT SRC_FK_PROVIDER_ID, SRC_YEAR, SRC_SPECIALTY, SRC_TAXONOMY, SRC_LEGACY_COST_SCORE, SRC_ENHANCED_COST_SCORE, SRC_LEGACY_QUALITY_SCORE, SRC_ENHANCED_QUALITY_SCORE, SRC_VERSION, 'historical/historical/PPI_CROSSWALK', NULL
FROM PROD_CJVRDC.ODS.VRDC_PPI_CROSSWALK
WHERE EFFECTIVE_FLAG AND RECORD_STATUS_CD = 'a';

INSERT INTO LOCAL_JUANVAGO.STAGE_VRDC.PPI_PAC_COST_SCORE (PAC_NUM, YEAR, TAXONOMY, CBSA, EPISODE, EPISODE_TYPE, PPI_COST_SCORE, COST_TEST_STATISTIC, HASH, VERSION, LOAD_FILE_NM, LOAD_FILE_ROW_NUM)
SELECT SRC_PAC_NUM, SRC_YEAR, SRC_TAXONOMY, SRC_CBSA, SRC_EPISODE, SRC_EPISODE_TYPE, SRC_PPI_COST_SCORE, SRC_COST_TEST_STATISTIC, SRC_HASH, SRC_VERSION, 'historical/historical/PPI_PAC_COST_SCORE', NULL
FROM PROD_CJVRDC.ODS.VRDC_PPI_PAC_COST_SCORE
WHERE EFFECTIVE_FLAG AND RECORD_STATUS_CD = 'a';

INSERT INTO LOCAL_JUANVAGO.STAGE_VRDC.PPI_PAC_COST_SCORECARD (PAC_NUM, EPISODE, EPISODE_TYPE, TAXONOMY, CBSA, NUM_EPISODES, AVG_OBSERVED, AVG_EXPECTED, AVG_OE, TEST_STATISTIC, AVG_HCC, AVG_CBSA_EPISODES, YEAR, TOT_PARTB_ALLOWED, TOT_INPATIENT_ALLOWED, TOT_OUTPATIENT_ALLOWED, TOT_SNF_ALLOWED, TOT_HHA_ALLOWED, TOT_HOSPICE_ALLOWED, TOT_PARTBDME_ALLOWED, VERSION, LOAD_FILE_NM, LOAD_FILE_ROW_NUM)
SELECT SRC_PAC_NUM, SRC_EPISODE, SRC_EPISODE_TYPE, SRC_TAXONOMY, SRC_CBSA, SRC_NUM_EPISODES, SRC_AVG_OBSERVED, SRC_AVG_EXPECTED, SRC_AVG_OE, SRC_TEST_STATISTIC, SRC_AVG_HCC, SRC_AVG_CBSA_EPISODES, SRC_YEAR, SRC_TOT_PARTB_ALLOWED, SRC_TOT_INPATIENT_ALLOWED, SRC_TOT_OUTPATIENT_ALLOWED, SRC_TOT_SNF_ALLOWED, SRC_TOT_HHA_ALLOWED, SRC_TOT_HOSPICE_ALLOWED, SRC_TOT_PARTBDME_ALLOWED, SRC_VERSION, 'historical/historical/PPI_PAC_COST_SCORECARD', NULL
...
SELECT SRC_PAC_NUM, SRC_YEAR, SRC_LEGACY_COST_SCORE, SRC_ENHANCED_COST_SCORE, SRC_LEGACY_QUALITY_SCORE, SRC_ENHANCED_QUALITY_SCORE, SRC_VERSION, 'historical/historical/PPI_PAC_CROSSWALK', NULL
...
SELECT SRC_PAC_NUM, SRC_YEAR, SRC_TAXONOMY, SRC_CBSA, SRC_PPI_QUALITY_SCORE, SRC_QUALITY_TEST_STATISTIC, SRC_VERSION, 'historical/historical/PPI_PAC_QUALITY_SCORE', NULL
...
SELECT SRC_PAC_NUM, SRC_MEASURE_ID, SRC_MEASURE_DESC, SRC_TAXONOMY, SRC_CBSA, SRC_PROBABILITY, SRC_PROB_PERCENTILE, SRC_NUMERATOR, SRC_DENOMINATOR, SRC_RATE, SRC_YEAR, SRC_VERSION, 'historical/historical/PPI_PAC_QUALITY_SCORECARD', NULL
...
SELECT SRC_FK_PROVIDER_ID, SRC_YEAR, SRC_TAXONOMY, SRC_CBSA, SRC_PPI_QUALITY_SCORE, SRC_QUALITY_TEST_STATISTIC, SRC_VERSION, 'historical/historical/NA_NPI_PPI_OUTCOMES_OPH_PROD', NULL
...
SELECT SRC_FK_PROVIDER_ID, SRC_MEASURE_ID, SRC_MEASURE_DESC, SRC_TAXONOMY, SRC_CBSA, SRC_PROBABILITY, SRC_PROB_PERCENTILE, SRC_NUMERATOR, SRC_DENOMINATOR, SRC_RATE, SRC_YEAR, SRC_VERSION, 'historical/historical/PPI_OUTCOMES_SCD_OPH_PROD', NULL
...
SELECT SRC_PAC_ZIP, SRC_PRIMARY_PRACTICE_SPECIALTY, SRC_OTHER_SPECIALTIES, SRC_ACO_ID, SRC_MULTI_ACO, 'historical/historical/na_ref_practice_group_lookup', NULL, SRC_PAC_NUM, SRC_YEAR, SRC_PRACTICE_GROUP
...
SELECT SRC_FK_PROVIDER_ID, SRC_ATTRIBUTION_TYPE, SRC_YEAR, SRC_METRIC_LABEL, SRC_METRIC, SRC_PAC_NUM, 'historical/historical/METRICS_PCP_EXPORT', NULL
...
SELECT SRC_PAC_NUM, SRC_YEAR, SRC_METRIC_ORDER, SRC_METRIC_LABEL, SRC_METRIC, 'historical/historical/ATTR_PG_PROFILE_LIST_EXPORT', NULL
FROM PROD_CJVRDC.ODS.VRDC_PROFILE_LIST_ATTR_PG
WHERE EFFECTIVE_FLAG AND RECORD_STATUS_CD = 'a';

--Error: SQL compilation error: error line 2 at position 7 invalid identifier 'SRC_FK_PROVIDER_ID' (There is not provider_id, facility_id instead)
...
SELECT SRC_FK_PROVIDER_ID, SRC_YEAR, SRC_METRIC_ORDER, SRC_METRIC_LABEL, SRC_METRIC, 'historical/historical/profile_list_facility', NULL
...
SELECT SRC_FK_PROVIDER_ID, SRC_YEAR, SRC_METRIC_LABEL, SRC_METRIC, 'historical/historical/PROVIDER_COST_UTILIZATION_POST_ACUTE', NULL
FROM PROD_CJVRDC.ODS.VRDC_PROFILE_LIST_POST_ACUTE
WHERE EFFECTIVE_FLAG AND RECORD_STATUS_CD = 'a';

--Error: NULL result in a non-nullable column (LOAD_FILE_ROW_NUM does not accept null, but the rest does)
...
SELECT SRC_FK_PROVIDER_ID, SRC_YEAR, SRC_METRIC_LABEL, SRC_METRIC, 'historical/historical/PROVIDER_COST_UTILIZATION_PRAC', NULL
...
SELECT SRC_PAC_NUM, SRC_YEAR, SRC_SPECIALTY, SRC_METRIC_ORDER, SRC_METRIC_LABEL, SRC_METRIC, SRC_METRIC_TOTAL, 'historical/historical/profile_list_rndrg_pg_partd', NULL
...
SELECT SRC_FK_PROVIDER_ID, SRC_PAC_NUM, SRC_YEAR, SRC_METRIC_ORDER, SRC_METRIC_LABEL, SRC_METRIC, 'historical/historical/profile_list_specialist', NULL
...
SELECT SRC_FK_PCP_PROVIDER_ID, SRC_QEXPU_HEADER_CD, SRC_SPECIALTY_CD, SRC_RENDERING_PROVIDER_ID, SRC_RENDERING_FACILITY_ID, SRC_PCP_PAC_NUM, SRC_RENDERING_PAC_NUM, SRC_YEAR, SRC_SPEND, SRC_BENE_COUNT, SRC_CLAIM_COUNT, 'historical/historical/NA_UTILIZATION_PCP', NULL
